...
public class Rester extends AsyncTask<JSONObject, Void, String> {
	...
	protected String doInBackground(JSONObject... params) {
		...
		dummyRest(params[0], params[1]);
		return null;
	}
	
	public void dummyRest(JSONObject connectionData, JSONObject postData) {
		String url, method, ip, port, function;
		try {
